...
for i in tqdm(range(no)):
	...
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'LogRegAdult', df)
...
for i in tqdm(range(no)):
	start_time = time.time()
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'LogRegAutomobile', df)
	execTime = execTime + (time.time() - start_time)
...
for i in tqdm(range(no)):
	start_time = time.time()
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'LogRegCarEval', df)
	execTime = execTime + (time.time() - start_time)
...
for i in tqdm(range(no)):
	start_time = time.time()
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'LogRegCPU', df)
	execTime = execTime + (time.time() - start_time)
...
for i in tqdm(range(no)):
	start_time = time.time()
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'LogRegDiabetes', df)
	execTime = execTime + (time.time() - start_time)
...
for i in tqdm(range(no)):
	start_time = time.time()
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'LogRegERA', df)
	execTime = execTime + (time.time() - start_time)
...
for i in tqdm(range(no)):
	start_time = time.time()
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'LogRegESL', df)
	execTime = execTime + (time.time() - start_time)
...
for i in tqdm(range(no)):
	start_time = time.time()
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'LogRegHousing', df)
	execTime = execTime + (time.time() - start_time)
...
for i in tqdm(range(no)):
	start_time = time.time()
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'LogRegMammo', df)
	execTime = execTime + (time.time() - start_time)
...
for i in tqdm(range(no)):
	start_time = time.time()
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'LogRegMpg', df)
	execTime = execTime + (time.time() - start_time)

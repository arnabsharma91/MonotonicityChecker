...
for i in tqdm(range(no)):
	...
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'GradBoostAdult', df)
...
for i in tqdm(range(no)):
	start_time = time.time()
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'GradBoostAutomobile', df)
	execTime = execTime + (time.time() - start_time)
...
for i in tqdm(range(no)):
	start_time = time.time()
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'GradBoostCarEval', df)
	execTime = execTime + (time.time() - start_time)
...
for i in tqdm(range(no)):
	start_time = time.time()
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'GradBoostCPU', df)
	execTime = execTime + (time.time() - start_time)
...
for i in tqdm(range(no)):
	start_time = time.time()
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'GradBoostDiabetes', df)
	execTime = execTime + (time.time() - start_time)
...
for i in tqdm(range(no)):
	start_time = time.time()
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'GradBoostERA', df)
	execTime = execTime + (time.time() - start_time)
...
for i in tqdm(range(no)):
	start_time = time.time()
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'GradBoostESL', df)
	execTime = execTime + (time.time() - start_time)
...
for i in tqdm(range(no)):
	start_time = time.time()
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'GradBoostHousing', df)
	execTime = execTime + (time.time() - start_time)
...
for i in tqdm(range(no)):
	start_time = time.time()
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'GradBoostMammo', df)
	execTime = execTime + (time.time() - start_time)
...
for i in tqdm(range(no)):
	start_time = time.time()
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'GradBoostMpg', df)
	execTime = execTime + (time.time() - start_time)

...
for i in tqdm(range(no)):
	...
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'AdaBoostAdult', df)
...
for i in tqdm(range(no)):
	start_time = time.time()
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'AdaBoostAutomobile', df)
	execTime = execTime + (time.time() - start_time)
...
for i in tqdm(range(no)):
	start_time = time.time()
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'AdaBoostCarEval', df)
	execTime = execTime + (time.time() - start_time)
...
for i in tqdm(range(no)):
	start_time = time.time()
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'AdaBoostCPU', df)
	execTime = execTime + (time.time() - start_time)
...
for i in tqdm(range(no)):
	start_time = time.time()
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'AdaBoostDiabetes', df)
	execTime = execTime + (time.time() - start_time)
...
for i in tqdm(range(no)):
	start_time = time.time()
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'AdaBoostERA', df)
	execTime = execTime + (time.time() - start_time)
...
for i in tqdm(range(no)):
	start_time = time.time()
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'AdaBoostESL', df)
	execTime = execTime + (time.time() - start_time)
...
for i in tqdm(range(no)):
	start_time = time.time()
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'AdaBoostHousing', df)
	execTime = execTime + (time.time() - start_time)
...
for i in tqdm(range(no)):
	start_time = time.time()
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'AdaBoostMammo', df)
	execTime = execTime + (time.time() - start_time)
...
for i in tqdm(range(no)):
	start_time = time.time()
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'AdaBoostMpg', df)
	execTime = execTime + (time.time() - start_time)

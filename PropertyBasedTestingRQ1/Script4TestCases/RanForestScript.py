...
for i in tqdm(range(no)):
	...
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'RanForestAdult', df)
...
for i in tqdm(range(no)):
	start_time = time.time()
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'RanForestAutomobile', df)
	execTime = execTime + (time.time() - start_time)
...
for i in tqdm(range(no)):
	start_time = time.time()
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'RanForestCarEval', df)
	execTime = execTime + (time.time() - start_time)
...
for i in tqdm(range(no)):
	start_time = time.time()
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'RanForestCPU', df)
	execTime = execTime + (time.time() - start_time)
...
for i in tqdm(range(no)):
	start_time = time.time()
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'RanForestDiabetes', df)
	execTime = execTime + (time.time() - start_time)
...
for i in tqdm(range(no)):
	start_time = time.time()
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'RanForestERA', df)
	execTime = execTime + (time.time() - start_time)
...
for i in tqdm(range(no)):
	start_time = time.time()
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'RanForestESL', df)
	execTime = execTime + (time.time() - start_time)
...
for i in tqdm(range(no)):
	start_time = time.time()
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'RanForestHousing', df)
	execTime = execTime + (time.time() - start_time)
...
for i in tqdm(range(no)):
	start_time = time.time()
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'RanForestMammo', df)
	execTime = execTime + (time.time() - start_time)
...
for i in tqdm(range(no)):
	start_time = time.time()
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'RanForestMpg', df)
	execTime = execTime + (time.time() - start_time)

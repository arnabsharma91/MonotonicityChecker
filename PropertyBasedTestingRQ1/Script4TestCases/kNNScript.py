...
for i in tqdm(range(no)):
	start_time = time.time()
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'kNNAutomobile', df)
	execTime = execTime + (time.time() - start_time)
...
for i in tqdm(range(no)):
	start_time = time.time()
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'kNNCarEval', df)
	execTime = execTime + (time.time() - start_time)
...
for i in tqdm(range(no)):
	start_time = time.time()
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'kNNCPU', df)
	execTime = execTime + (time.time() - start_time)
...
for i in tqdm(range(no)):
	start_time = time.time()
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'kNNDiabetes', df)
	execTime = execTime + (time.time() - start_time)
...
for i in tqdm(range(no)):
	start_time = time.time()
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'kNNERA', df)
	execTime = execTime + (time.time() - start_time)
...
for i in tqdm(range(no)):
	start_time = time.time()
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'kNNESL', df)
	execTime = execTime + (time.time() - start_time)
...
for i in tqdm(range(no)):
	start_time = time.time()
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'kNNHousing', df)
	execTime = execTime + (time.time() - start_time)
...
for i in tqdm(range(no)):
	start_time = time.time()
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'kNNMammo', df)
	execTime = execTime + (time.time() - start_time)
...
for i in tqdm(range(no)):
	start_time = time.time()
	cexPair = quickTestMlAt.funcMain(MAX_SAMPLES, 'kNNMpg', df)
	execTime = execTime + (time.time() - start_time)

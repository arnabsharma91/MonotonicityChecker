...
f = open('Output/NBRanTestOutputFile.txt', 'w')

f.write("\n")
f.write("Execution result of NB with random testing approach:\n")
...
for i in tqdm(range(no)):
	cexPair, failed_att, execution_time = NBAdult.func_main(MAX_SAMPLES)
...
failed_trials = 0
for i in tqdm(range(no)):
	cexPair, failed_att, execution_time = NBAutomobile.func_main(MAX_SAMPLES)
	execTime = execTime + execution_time
	failed_trials = failed_trials+failed_att
...
failed_trials = 0
for i in tqdm(range(no)):
	cexPair, failed_att, execution_time = NBCarEval.func_main(MAX_SAMPLES)
	execTime = execTime + execution_time
	failed_trials = failed_trials+failed_att
...
failed_trials = 0
for i in tqdm(range(no)):
	cexPair, failed_att, execution_time = NBCPU.func_main(MAX_SAMPLES)
	execTime = execTime + execution_time
	failed_trials = failed_trials+failed_att
...
failed_trials = 0
for i in tqdm(range(no)):
	cexPair, failed_att, execution_time = NBDiabetes.func_main(MAX_SAMPLES)
	execTime = execTime + execution_time
	failed_trials = failed_trials+failed_att
...
failed_trials = 0
for i in tqdm(range(no)):
	cexPair, failed_att, execution_time = NBERA.func_main(MAX_SAMPLES)
	execTime = execTime + execution_time
	failed_trials = failed_trials+failed_att
...
failed_trials = 0
for i in tqdm(range(no)):
	cexPair, failed_att, execution_time = NBESL.func_main(MAX_SAMPLES)
	execTime = execTime + execution_time
	failed_trials = failed_trials+failed_att
...
failed_trials = 0
for i in tqdm(range(no)):
	cexPair, failed_att, execution_time = NBHousing.func_main(MAX_SAMPLES)
	execTime = execTime + execution_time
	failed_trials = failed_trials+failed_att
...
failed_trials = 0
for i in tqdm(range(no)):
	cexPair, failed_att, execution_time = NBMammo.func_main(MAX_SAMPLES)
	execTime = execTime + execution_time
	failed_trials = failed_trials+failed_att
